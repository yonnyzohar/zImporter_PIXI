...
const GameTimer_1 = require("./GameTimer"); // Make sure to provide the correct path to your files
class TimelineSprite extends GameContainer_1.GameContainer {
    constructor() {
        super();
        this.currentFrame = 0;
        this.looping = true;
    ...
    play() {
        GameTimer_1.GameTimer.addUpdateAble(this);
    ...
    stop() {
        GameTimer_1.GameTimer.removeUpdateAble(this);
        for (let i = 0; i < this.children.length; i++) {
            const child = this.children[i];
            if (child instanceof TimelineSprite) {
                child.stop();
